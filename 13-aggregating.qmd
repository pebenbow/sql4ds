...
The subtotal and grand total rows have `NULL` in the columns that were rolled up. The following query counts actors by birth country and genre for three countries, with subtotals per country and a grand total:
