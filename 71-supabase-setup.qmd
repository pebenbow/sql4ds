...
External tools such as DataGrip, DBeaver, or the VS Code extensions introduced in the next chapter connect to your Supabase database using a connection string. To find yours:
