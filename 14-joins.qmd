...
The diagrams in this chapter use the **checkered flag** method to illustrate joins, adapted from @martinson2022. Each diagram shows two tables arranged as rotated grids facing each other. Color-coded cells identify which rows from each table contribute to the result, and a result table on the right shows the output.
